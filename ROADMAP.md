...
- **Azure Key Vault provider** (`Moongazing.OrionVault.AzureKeyVault`) -> v0.2.4 (shipped 2026-06-10: RSA-OAEP-256 default + AES-KW option, mocked-vault unit tests).
- **LocalStack + Azure integration test matrix** -> v0.2.5 (shipped 2026-06-10).
